        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stores_AspNetUsers_Supplier_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipTo_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipTo_Street = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipTo_City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipTo_Country = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Pro_Img = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Pro_Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Images", x => new { x.Pro_Id, x.Pro_Img });
                    table.ForeignKey(
                        name: "FK_Images_Products_Pro_Id",
                        column: x => x.Pro_Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Rev_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Pro_Id = table.Column<int>(type: "int", nullable: false),
                    Pro_Review = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reviews", x => new { x.Rev_Id, x.Pro_Id });
                    table.ForeignKey(
                        name: "FK_Reviews_Products_Pro_Id",
                        column: x => x.Pro_Id,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
